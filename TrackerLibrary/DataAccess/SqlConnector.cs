...
namespace TrackerLibrary.DataAccess
{
    public class SqlConnector : IDataConnection
    {
        ...
        // TODO - Make the createPrize method actually save data
        /// <summary>
        /// Saves a new price to the database
        /// </summary>
        /// <param name="model">The price information</param>
        /// <returns>The prize information and the unique Id</returns>
        ...
        public List<PersonModel> GetPerson_All()
        {
            ...
            using (IDbConnection connection = new System.Data.SqlClient.SqlConnection(GlobalConfig.connectionString(db)))
            {
                output = connection.Query<PersonModel>("dbo.spPlayers_GetAll").ToList();
            }
